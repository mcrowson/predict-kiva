...
Use Kiva's data snapshot to predict which loans' delinquency and default. This code was created as part of Matthew Crowson's thesis requirement for graduation from 
...
## Install
You'll need a few things to run the script:
